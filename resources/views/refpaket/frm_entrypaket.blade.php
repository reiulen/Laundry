                ...
                <div class="row">
                  <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <form class="formValidate" id="formValidate" method="post" action="{{ route('refpaket.store') }}">
                          @csrf
                          <div class="row">
                            <div class="input-field col s12">                              
                              <i class="mdi-toggle-check-box prefix"></i>
                              <input id="nomor_paket" type="text"  value="{{ old('no_paket') }}"  name="no_paket" class="validate" placeholder="CSR1" required>
                          ...
                          <div class="row">
                            <div class="input-field col s6">
                              ...
                              <input id="nama_paket" name="nama_paket" value="{{ old('nama_paket') }}" type="text" class="validate" placeholder="Cuci + Setrika" required>
                            ...
                            <div class="input-field col s6">
                              ...
                              <input id="jenis_paket" name="jenis_paket" type="text" value="{{ old('jenis_paket') }}" class="validate" placeholder="Regular" required>
                          ...
                          <div class="row">
                            <div class="input-field col s6">
                              ...
                              <input id="jmlhari" type="text" name="jumlah_hari" value="{{ old('jumlah_hari') }}" class="validate" placeholder="1" required>
                            ...
                            <div class="input-field col s6">
                              ...
                              <input id="harga" name="harga" type="text" value="{{ old('harga') }}" class="validate" placeholder="70000" required>
                            ...
                            <div class="input-field col s12">
                              <select id="satuan" name="satuan" required>
                                ...
                                <option value="{{ old('satuan') }}" disabled selected>{{ old('satuan') }}</option>
                                  @else
                                  <option value="" disabled selected>Pilih Satuan Paket</option>
                                @endif
