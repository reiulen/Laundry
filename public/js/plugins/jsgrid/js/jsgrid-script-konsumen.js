$(function() {
            ...
            $("#jsGrid-static").jsGrid({
                ...
                paging: true,
                fields: [
                    { name: "no_konsumen", type: "text", width: 50, title: "No Konsumen" },
                    { name: "nama_konsumen", type: "text", width: 150, title: "Nama Konsumen" },
                    { name: "alamat", type: "text", width: 300, title: "Alamat" },
                    { name: "telepon", type: "text", title: "Telepon" }
                ],
                data: db.clients
            });
            // Basic Data
