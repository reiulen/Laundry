$(function() {
            ...
            $("#jsGrid-static").jsGrid({
                ...
                paging: true,
                fields: [
                    { name: "no_karyawan", type: "text", width: 50, title: "No Karyawan" },
                    { name: "nama_karyawan", type: "text", width: 200, title: "Nama Karyawan" },
                    { name: "username", type: "text", width: 200, title: "User Name" },
                    { name: "password", type: "text", title: "Password" },
