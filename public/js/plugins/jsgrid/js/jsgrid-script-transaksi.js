$(function() {
            ...
            $("#jsGrid-static").jsGrid({
                ...
                paging: true,
                fields: [
                    { name: "no_order", type: "text", width: 75, title: "No Order" },
                    { name: "nama_konsumen", type: "text", title: "Nama Konsumen" },
                    { name: "paket", type: "text", width: 125, title: "Paket" },
                    { name: "waktu", type: "text", width: 50, title: "Waktu" },
                    { name: "tgl_selesai", type: "text", title: "Tgl Selesai" },
                    { name: "status_bayar", type: "text", width: 60, title: "Status Bayar" },
                    { name: "status_order", type: "select", items: db.statusorder, valueField: "Id", textField: "Name", title: "Statud Order" }
                ],
                data: db.clients
            });
            // Basic Data
